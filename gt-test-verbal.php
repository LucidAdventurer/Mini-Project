<?php
/* ============================================================
 * Verbal Ability Test PAGE  (guest-accessible)
 * Fetches MCQ questions from the `questions` + `assessments`
 * tables where category = 'english' and is_public = 1.
 *
...
// ── Fetch active public english assessments ─────────────────
$assessments = [];
...
if ($aid > 0) {
    ...
    $aCheck = safePreparedQuery(
        ...
        "SELECT assessment_id, title, description, duration_minutes,
         ...
         FROM assessments
         WHERE assessment_id = ? AND category = 'english'
...
<title>Verbal Ability Test – Placement &amp; Training Portal</title>
...
<div class="page-header">
    ...
    <div class="cat-badge">📝 Verbal Ability</div>
    <h1 class="page-title">
        <?php if ($activeAssmt): ?>
...
<div class="assmt-grid">
    <?php if (empty($assessments)): ?>
        <div class="empty-state" style="grid-column:1/-1">
            ...
            <p class="empty-sub">The admin hasn&#39;t published any Verbal Ability tests. Check back soon!</p>
        </div>
    <?php else: ?>
