<?php
/* ============================================================
 * VERBAL TEST PAGE  (guest-accessible)
 * Fetches MCQ questions from the `questions` + `assessments`
 * tables where category = 'verbal' and is_public = 1.
 * ============================================================ */
...
if ($aid > 0) {
    ...
    $aCheck = safePreparedQuery(
        ...
        "SELECT assessment_id, title, description, duration_minutes,
         ...
         FROM assessments
         WHERE assessment_id = ? AND category = 'verbal'
...
<title>Verbal Test – Placement & Training Portal</title>
...
:root {
    ...
    --line:      #e4e4e7; --r: 10px;
    --accent:    #be185d; --accent-bg: #fdf2f8; --accent-line: #fbcfe8;
...
.progress-bar { height: 100%; background: #be185d; border-radius: 99px; transition: width 0.3s; }
...
<div class="page-header">
    ...
    <div class="cat-badge">📝 Verbal</div>
    <h1 class="page-title">
        <?php if ($activeAssmt): ?>
    ...
    <p class="page-sub">
        ...
        <?php else: ?>
            Practice grammar, comprehension, vocabulary and reading skills. Choose a test below to begin.
        <?php endif; ?>
    </p>
</div>
...
<div class="assmt-grid">
    ...
    <?php else: ?>
        ...
        <div class="assmt-card">
            ...
            <a href="test-verbal.php?id=<?= $a['assessment_id'] ?>" class="btn-start">
                Start Test →
            </a>
        </div>
        <?php endforeach; ?>
...
<div class="empty-state">
    ...
    <br><a href="test-verbal.php" class="btn-start">← Back to Verbal Tests</a>
</div>
...
<div class="result-overlay" id="resultOverlay">
    <div class="result-modal">
        ...
        <div class="result-actions">
            <a href="test-verbal.php" class="btn-nav">← All Verbal Tests</a>
