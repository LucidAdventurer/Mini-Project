...
.brand-text{font-family: 'Times New Roman', Times, serif;font-size:14px;font-weight:800;letter-spacing:-0.01em;color:var(--text);}
.brand-text span{font-family:'DM Sans',sans-serif;font-size:10.5px;font-weight:400;color:var(--muted);display:block;letter-spacing:0;}
.sidebar-nav{flex:1;padding:12px 8px;overflow-y:auto;display:flex;flex-direction:column;gap:1px;}
.nav-section-label{font-size:9.5px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:var(--muted);padding:10px 10px 5px;margin-top:4px;}
.nav-item{display:flex;align-items:center;gap:9px;padding:8px 11px;border-radius:7px;cursor:pointer;transition:background 0.15s,color 0.15s;color:var(--muted);font-size:13px;font-weight:500;user-select:none;text-decoration:none;position:relative;}
...
.nav-badge{margin-left:auto;background:var(--red);color:white;font-size:9.5px;font-weight:700;padding:1px 5px;border-radius:9px;min-width:17px;text-align:center;}
...
.topbar-title{font-family: 'Times New Roman', Times, serif;font-size:14px;font-weight:700;color:var(--text);flex:1;}
.topbar-title span{color:var(--muted);font-weight:400;font-size:13px;font-family:'DM Sans',sans-serif;}
...
.admin-avatar{width:24px;height:24px;background:var(--accent);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:700;color:white;}
.admin-chip span{font-size:12px;font-weight:600;color:var(--text);}
...
.dd-avatar{width:40px;height:40px;border-radius:50%;background:var(--accent);display:flex;align-items:center;justify-content:center;font-family: 'Times New Roman', Times, serif;font-weight:700;font-size:15px;color:white;margin-bottom:10px;}
.dd-name{font-size:13.5px;font-weight:600;color:var(--text);}
.dd-email{font-size:11.5px;color:var(--muted);margin-top:2px;}
.dd-role{display:inline-block;margin-top:7px;padding:2px 10px;background:rgba(59,130,246,0.12);border:1px solid rgba(59,130,246,0.25);color:var(--accent2);border-radius:20px;font-size:10.5px;font-weight:600;letter-spacing:0.05em;text-transform:uppercase;}
.dd-menu{padding:5px 0;}
.dd-item{display:flex;align-items:center;gap:10px;padding:9px 16px;color:var(--dim);text-decoration:none;font-size:13px;transition:background 0.15s,color 0.15s;cursor:pointer;border:none;background:none;width:100%;text-align:left;font-family:'DM Sans',sans-serif;}
...
.section-header h2{font-family: 'Times New Roman', Times, serif;font-size:19px;font-weight:800;letter-spacing:-0.03em;}
...
.stat-value{font-family: 'Times New Roman', Times, serif;font-size:24px;font-weight:800;color:var(--text);line-height:1;margin-bottom:4px;letter-spacing:-0.03em;}
...
.card-header h3{font-family: 'Times New Roman', Times, serif;font-size:13.5px;font-weight:700;}
...
thead th{padding:9px 14px;text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:var(--muted);background:var(--ink3);border-bottom:1px solid var(--line);}
...
.user-av{width:28px;height:28px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:700;color:white;flex-shrink:0;}
...
/* ── BADGES ── */
.badge{display:inline-flex;align-items:center;gap:3px;padding:2px 8px;border-radius:20px;font-size:10.5px;font-weight:600;}
...
.bar-label{font-size:11.5px;color:var(--muted);width:88px;flex-shrink:0;}
...
.bar-val{font-size:11.5px;font-weight:700;color:var(--text);width:30px;text-align:right;}
...
/* ── SEARCH ── */
.search-bar{display:flex;align-items:center;gap:7px;background:var(--ink3);border:1px solid var(--line);border-radius:8px;padding:7px 11px;font-size:12.5px;color:var(--muted);margin-bottom:14px;}
.search-bar svg{width:13px;height:13px;stroke:var(--muted);fill:none;stroke-width:2;}
.search-bar input{background:none;border:none;outline:none;font-family:'DM Sans',sans-serif;font-size:12.5px;color:var(--text);flex:1;}
.search-bar input::placeholder{color:var(--muted);}

/* ── TABS ── */
.tabs{display:flex;gap:3px;margin-bottom:16px;background:var(--ink3);padding:3px;border-radius:9px;width:fit-content;}
.tab{padding:5px 14px;border-radius:6px;font-size:12px;font-weight:600;cursor:pointer;color:var(--muted);transition:all 0.15s;border:none;background:none;font-family:'DM Sans',sans-serif;}
...
.resource-card h4{font-size:12.5px;font-weight:700;margin-bottom:4px;}
.resource-card p{font-size:11.5px;color:var(--muted);line-height:1.5;}
.resource-meta{font-size:10.5px;color:var(--muted);margin-top:9px;display:flex;justify-content:space-between;}

/* ── LOG ENTRIES ── */
.log-entry{display:flex;align-items:center;gap:13px;padding:9px 15px;border-bottom:1px solid var(--line);font-size:11.5px;font-family:'DM Mono',monospace;}
...
.setting-group label{display:block;font-size:11px;font-weight:700;color:var(--muted);text-transform:uppercase;letter-spacing:0.06em;margin-bottom:6px;}
.setting-input{width:100%;padding:8px 11px;background:var(--ink3);border:1px solid var(--line);border-radius:8px;font-family:'DM Sans',sans-serif;font-size:12.5px;color:var(--text);outline:none;}
...
.toggle-info h4{font-size:12.5px;font-weight:600;}
.toggle-info p{font-size:11.5px;color:var(--muted);margin-top:2px;}
...
/* ── BUTTONS ── */
.btn{display:inline-flex;align-items:center;gap:5px;padding:7px 13px;border-radius:7px;font-family:'DM Sans',sans-serif;font-size:12px;font-weight:600;cursor:pointer;border:none;transition:all 0.15s;}
...
.modal h3{font-family: 'Times New Roman', Times, serif;font-size:15px;font-weight:800;margin-bottom:18px;letter-spacing:-0.02em;}
...
.form-group label{display:block;font-size:10.5px;font-weight:700;text-transform:uppercase;letter-spacing:0.06em;color:var(--muted);margin-bottom:5px;}
.form-input{width:100%;padding:8px 11px;background:var(--ink3);border:1px solid var(--line);border-radius:7px;font-family:'DM Sans',sans-serif;font-size:12.5px;color:var(--text);outline:none;box-sizing:border-box;}
...
/* ── TOAST ── */
.toast{position:fixed;bottom:22px;right:22px;z-index:999;background:var(--ink2);border:1px solid var(--line);border-radius:9px;padding:11px 16px;font-size:12.5px;font-weight:600;display:flex;align-items:center;gap:9px;box-shadow:0 8px 28px rgba(0,0,0,0.5);transform:translateY(70px);opacity:0;transition:all 0.3s ease;pointer-events:none;}
...
/* ── PAGINATION ── */
.pagination{display:flex;align-items:center;justify-content:space-between;padding:12px 15px;border-top:1px solid var(--line);font-size:11.5px;color:var(--muted);}
.pagination-btns{display:flex;gap:3px;}
.pagination-btns button{padding:4px 9px;border-radius:5px;font-size:11.5px;background:var(--ink3);border:1px solid var(--line);color:var(--text);cursor:pointer;font-family:'DM Sans',sans-serif;}
