...
//
// Admin-only version of parse-document.php.
// Identical parsing logic — only the session role differs.
// DO NOT modify api/assessment/parse-document.php (teacher use).
//
