<?php
/* ============================================================
 * Technical Test PAGE  (guest-accessible)
 * Fetches MCQ questions from the `questions` + `assessments`
 * tables where category = 'technical' and is_public = 1.
 *
...
// ── Fetch active public technical assessments ─────────────────
$assessments = [];
...
if ($aid > 0) {
    ...
    $aCheck = safePreparedQuery(
        ...
        "SELECT assessment_id, title, description, duration_minutes,
         ...
         FROM assessments
         WHERE assessment_id = ? AND category = 'technical'
...
<title>Technical Test – Placement &amp; Training Portal</title>
...
<div class="page-header">
    ...
    <div class="cat-badge">💻 Technical</div>
    <h1 class="page-title">
        <?php if ($activeAssmt): ?>
            <?= htmlspecialchars($activeAssmt['title']) ?>
        <?php else: ?>
            Technical &amp; CS Fundamentals Tests
        <?php endif; ?>
    </h1>
    <p class="page-sub">
        <?php if ($activeAssmt): ?>
        ...
        <?php else: ?>
            Practice data structures, algorithms, OOP, DBMS and CS basics. Choose a test below to begin.
        <?php endif; ?>
    </p>
</div>
...
<div class="assmt-grid">
    <?php if (empty($assessments)): ?>
        <div class="empty-state" style="grid-column:1/-1">
            ...
            <p class="empty-sub">The admin hasn&#39;t published any Technical tests. Check back soon!</p>
        </div>
    <?php else: ?>
        ...
        <div class="assmt-card">
            ...
            <a href="test-technical.php?id=<?= $a['assessment_id'] ?>" class="btn-start">
                Start Test →
            </a>
        </div>
        <?php endforeach; ?>
...
<div class="empty-state">
    ...
    <br><a href="test-technical.php" class="btn-start">← Back to Technical Tests</a>
</div>
...
<div class="result-overlay" id="resultOverlay">
    <div class="result-modal">
        ...
        <div class="result-actions">
            <a href="test-technical.php" class="btn-nav">← All Technical Tests</a>
